...
function updatePlayIcon() {   // ye icon ke lia kam kare ga play horhi he to pause icon or viceversa
    if (video.paused) {
...
function updateProgress() {
    ...
    progress.value = (video.currentTime / video.duration * 100); // is se total video ki percentage ajye gi
